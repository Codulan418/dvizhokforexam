...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 29 2026 г., 13:25
...
CREATE TABLE `about` (
  ...
  `text3` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `advantages` (
  `id` int NOT NULL,
  `img` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `contacts` (
  ...
  `working_hours` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `doc` (`id`, `number`, `name`, `status`) VALUES
(1, 1, 'сверстать страницы', 'в работе'),
(2, 1, 'сверстать страницы', 'в работе');
...
CREATE TABLE `doc_detail` (
  `id` int NOT NULL,
  `doc_id` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tab_key` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tab-icon` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tab_title` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tab_subtitle` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `block_label` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `block_title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `block_content` text COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `doc_detail` (`id`, `doc_id`, `tab_key`, `tab-icon`, `tab_title`, `tab_subtitle`, `block_label`, `block_title`, `block_content`, `tags`) VALUES
(1, '1', 'web', '</>', 'Web-приложение', 'React + Node.js + PostgreSQL', 'WEB-ПРИЛОЖЕНИЕ', 'Разработка веб-прилоения', 'React + Vite для frontend, Node.js + Express для API и PostgreSQL с Prisma для хранения данных.', 'React, Flutter, Node.js'),
(2, '1', 'web', '</>', 'Web-приложение', 'React + Node.js + PostgreSQL', 'WEB-ПРИЛОЖЕНИЕ', 'Разработка веб-прилоения', 'React + Vite для frontend, Node.js + Express для API и PostgreSQL с Prisma для хранения данных.', 'React');
...
CREATE TABLE `record` (
  ...
  `car_brand` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `car_year` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reviews` (
  ...
  `rating` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_approved` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `services` (
  ...
  `price` int NOT NULL,
  `type` enum('Профилактика','Ремонт','Доп.услуги') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `staff` (
  ...
  `img` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `speciality` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `experience` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `password_hash` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
